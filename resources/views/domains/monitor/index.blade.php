...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="box">
        ...
        <div class="p-5">
            @foreach ($disk['mounts'] as $mount)

            <div class="mb-3">
                <div class="flex">
                    <div class="flex-1 font-medium">{{ $mount['path'] }}</div>
                    <div class="text-slate-500">@sizeHuman($mount['load']) / @sizeHuman($mount['size'])</div>
                </div>

                <div class="flex mt-2 items-center">
                    @progressbar($mount['percent'], 'flex-1 h-3')

                    <div class="text-slate-400 ml-3">{{ $mount['percent'] }}%</div>
                </div>
            </div>
